...
RSpec.describe "/posts", type: :request do
  ...
  ##################################################################################
  #                                                                                #
  #  Next block is taken from The Relish RSpec documentation site:                 #
  ...
  #   # post = Post.new(title: 'The title', body: 'The Body', user_id: current_user.id)

  #   post "/posts", :params => { :post => {:title => "My Widget", :body => "This is the body" } }
